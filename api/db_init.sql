-- Database creation script for CTU Athenaeum (XAMPP / local MySQL)
-- For Railway: import api/db_schema.sql into the database Railway provisions (no CREATE DATABASE).
CREATE DATABASE IF NOT EXISTS ctulibrarysystem CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE ctulibrarysystem;
